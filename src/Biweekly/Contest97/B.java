...
public class B {
    public static void main(String[] args) {
     ...
     int a =    maximizeWin(new int[]{1,1,2,2,3,3,5},0);
        out.println(a);
    }
...
return 1;
    ...
    public static int maximizeWin(int[] pp, int k) {
...
//        System.out.println(map);
        ...
        while(cur != null){
            ...
            int c = k;
            int sum = 0;
            while(firstK != null && c > 0 ){

                sum += map.get(firstK);
                firstK = map.higherKey(firstK);
                c--;
            }
            pq.add(sum);
            c=  k;
