...
public class C {
    public static void main(String[] args) {
        DSU s = new DSU(12);
        s.merge(1,2);
        out.println(Arrays.toString(s.dsu));
    }
...
//            int xx = p.getKey();
//            int yy = p.getValue();
//            Pair<Integer,Integer> first = map.get(i+1);
//            int xa =  first.getKey();
//            int yb =first.getValue();
//            boolean flag = false;
//            for(int a = 0; a < 4; a++){
//                if(xx + x[a] >= 0 && xx + x[a] < n && yy + y[a] >= 0 && (yy + y[a]) < n ){
//                    if(xx + x[a] ==xa && yy + y[a] ==yb ){
//                        flag= true;
//                    }
//                }
//            }
...
//        }
    ...
    public static int beautifulSubsets(int[] nums, int value) {
        int answer =0;
    ...
    private static  int  positiveMod(int x , int value){
        // x negative then it works
        int mod  = (((x % value) + value) % value);
        return mod;
    }
    private static long positiveMod(long x , long value){
        long mod  = (((x % value) + value) % value);
        return mod;
    }
