...
//            a = a.pow(n);
//            a = a.subtract(BigInteger.TWO);
//            a = a.mod(new BigInteger(String.valueOf(1000000007)));
//            int ans = Integer.parseInt(a.toString());
//
//            long nn = (long) Math.pow(2,n) % 1000000007;
//            nn-=2;
            long aa = power(2, n, 1000000007);
        out.println(aa);
