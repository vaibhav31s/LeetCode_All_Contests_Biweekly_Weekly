...
public class A {
    public static void main(String[] args) {
        ...
        int t = 1;
        out.println(numTimesAllBlue(new int[]{4,1,2,3,1,1}));
    }

    public static int numTimesAllBlue(int[] flips) {
        SegmentTree seg  = new SegmentTree(0,flips.length+1);
        int max = 0;
...
//            out.println(sum);
    ...
    public static int minimizeMax(int[] nums, int p) {
        ...
        while(p > 0){
            Integer first = map.pollFirstEntry().getKey();
            Integer second = map.pollFirstEntry().getKey();
