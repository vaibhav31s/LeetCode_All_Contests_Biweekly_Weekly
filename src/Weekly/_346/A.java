...
//            out.println(makeSmallestPalindrome("egcfe"));
            out.println(punishmentNumber(10));
        }
    ...
    static boolean[] isGood = new boolean[10001];
...
//            out.println(sqr);
    ...
    private static boolean good(long i, long sqr) {
        List<List<String>> answer =new ArrayList<>();
        List<String> temp = new ArrayList<>();
        if(dfs(i, String.valueOf(sqr), 0,new ArrayList<>())){
...
//        out.println(answer);
   ...
   static boolean dfs(long ans, String s, int start,  List<String> temp ){
        if(start == s.length()){
            long sum = 0;
            for(String x : temp){
