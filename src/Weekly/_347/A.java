...
public class A {
    public static void main(String[] args) {
        out.println(removeTrailingZeros("0011"));
        out.println(minimumCost("010101"));
    }
    ...
    public static long minimumCost(String s) {
        int mid = s.length()/2;
        int mid2 = intCeil(s.length(),2);
        if(s.length()%2 == 0) mid--;
        out.println(mid+  " " + mid2);
        ...
        long answer =0;
        //if fliping then 0 is 1 and 1 is 0;
        while(mid>=0){
            if(arr[mid] =='0' && !one){
        ...
        while(mid2 < s.length()){
            ...
            if(arr[mid2] == '0' && one){
                answer+= s.length() - mid2;
                one = false;
            }else if(arr[mid2] == '1' && !one){ //its 0
                answer += s.length() - mid2;
                one = true;
            }
            mid2++;
         ...
         mid = s.length()/2;
         mid2 = intCeil(s.length(),2);
        if(s.length()%2 == 0) mid--;
        long answer1 =0;
        while(mid>=0){
            if(arr[mid] == '0' && zero){

            }else if(arr[mid] == '0' && !zero) {
                // 0 is 1
                answer1 += mid+1;
                zero = true;
            }else if(arr[mid] == '1' && zero){
                answer1+= mid+1;
                zero= false;
            }else{
        ...
        while(mid2 < s.length()){
            ...
            }else if(arr[mid2] == '0' && !zero) {
                // 0 is 1
                answer1 += s.length()-mid2;
                zero = true;
            }else if(arr[mid2] == '1' && zero){
                answer1 += s.length()-mid2;
                zero= false;
            }else{
